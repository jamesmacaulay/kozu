...
var agnostic = buildAgnosticWrapper();
var iteratorAgnostic = buildAgnosticWrapper(
  core.mapper(all)
);
var higherOrderAgnostic = buildAgnosticWrapper(
  core.mapper(agnostic)
);
var firstArgumentArrayAgnostic = buildAgnosticWrapper(
  core.inputTransformer(allArrayItems)
);

agnostic.compose = higherOrderAgnostic(core.compose);
agnostic.map = firstArgumentArrayAgnostic(core.map);
